...
//!
//! It exists so that structural refactors of the encoder implementation — the
//! former `src/encode/pipeline.rs`, now `src/encode/pipeline_impl/` — can be
...
//! requested DCT method — and an aarch64 run of all 33,600 cases against these
...
/// 33,600 cases against these x86_64-generated bytes now passes with zero
